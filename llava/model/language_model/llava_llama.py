...
class LlavaLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    ...
    def __init__(self, config):
        ...
        self.tot = [1 for _ in range(config.num_hidden_layers)]
        
        self.sum_0 = [0.1 for _ in range(config.num_hidden_layers)]
        self.sum_1 = [0.1 for _ in range(config.num_hidden_layers)]
